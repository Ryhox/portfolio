...
export const HEART = { x: 0, z: -2, r: 20, height: 8.5 }
...
// Main trail: south beach -> up the hill -> east to the nook. One clean,
// gently drifting curve (no hard side-to-side weaving, which read as several
// overlapping paths).
