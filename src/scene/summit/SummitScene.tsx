...
import { Logo3D } from '../props/Logo3D'
import { InteractMarker } from '../interact/InteractMarker'
import { ACTIVE, activateNearest, refreshNearest, registerInteract, unregisterInteract } from '../interact/interact'
import { ARC_CENTER, PEDESTAL_HEIGHT, PORTRAIT, type PedestalSpot, type SocialDef, pedestalSpots } from './summit'
import { useT, tg, type StringKey } from '../../i18n/index'
